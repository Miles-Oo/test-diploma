...
public class DialogueManagerTest : MonoBehaviour
{
    ...
    public void StartDialogue(GameObject npcObj)
    {
        ...
        var npcDialogue = npcObj.GetComponent<NPCDialogueTest>();
        ...
        if (npcDialogue != null && npcDialogue.availableDialogues.Count > npcDialogue.currentDialogueIndex)
        {
        DialogueAsset activeAsset = npcDialogue.availableDialogues[npcDialogue.currentDialogueIndex];
        
        DialogueNode nodeToShow = npcDialogue.lastNodeUsed;

        if (nodeToShow == null || nodeToShow.options == null || nodeToShow.options.Length == 0)
        {
            nodeToShow = activeAsset.startNode;
        }
    ...
    public void EndDialogue()
    {
        ...
        if (currentNPCObject != null)
        {
            ...
            if (npcDialogue != null)
            {
                npcDialogue.SetNextDialogue();
                npcDialogue.lastNodeUsed = null;
            }
        ...
        OnDialogueEnded?.Invoke(currentNPCObject);
